...
const handleLogout = () =>{
  ...
  .catch(error =>console.log(error.code))
    ...
    <NavLink to='/collages' className="me-2">Collages</NavLink>

    <NavLink to='/admission'  className="me-2">Admission</NavLink>
    <NavLink to='/myCollage' className="me-2">My Collages</NavLink>
</>
  ...
  <div className="navbar-start">
    ...
    <div className="flex flex-col items-center w-25 h-25   md:ms-5">
        <img className="h-14 hidden md:block" src={logo} alt="" />
    </div>
    <Link className="text-xl md:ms-10 md:text-3xl  font-bold text-cyan-300">DU 7 Collage</Link>
  </div>
...
<Link to={`/updateForm/${user.email}`}>    <div className="avatar online me-2 md:me-5">
